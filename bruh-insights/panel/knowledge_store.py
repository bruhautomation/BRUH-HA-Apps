"""Local knowledge base for BRUH Insights — what the analyst has learned.

This is the add-on's own durable memory, independent of the BRUH Terminal
...
KNOWLEDGE_FILE = os.environ.get("BRUH_INSIGHTS_KNOWLEDGE_FILE", "/data/knowledge.json")
