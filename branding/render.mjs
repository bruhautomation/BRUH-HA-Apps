...
const APPS = [
	...
	{
		name: 'BRight',
		tile: 'bright/bright-tile-dark.svg',
		logo: 'bright/bright-logo-ondark.svg',
		squares: [
			['bright/icon.png', 256],
			['bright/custom_components/bright/brand/icon.png', 256],
			['bright/custom_components/bright/brand/icon@2x.png', 512],
			['brands/custom_integrations/bright/icon.png', 256],
			['brands/custom_integrations/bright/icon@2x.png', 512],
		],
		lockups: [
			['bright/logo.png', 512, 384],
			['bright/custom_components/bright/brand/logo.png', 341, 256],
			['bright/custom_components/bright/brand/logo@2x.png', 682, 512],
			['brands/custom_integrations/bright/logo.png', 341, 256],
			['brands/custom_integrations/bright/logo@2x.png', 682, 512],
		],
	},
	{
		name: 'BRUH Minecraft',
